...
const postDataToAPI = async(data)=>{
  const apiUrl = 'http://localhost:5000/test/house/login';
  try{
...
const onSubmit = (data)=>{
      postDataToAPI(data).then(()=>history('/user/welcome'));
};
// console.log(errors);
      ...
      >
        ...
        > 
          <TextField
            ...
            placeholder="Plot No" {...register("plotNo", {required: true})}
          ...
          <TextField
            ...
            variant="standard"
            size="small"
            placeholder="Contact No" {...register("contactNo", {required: true})}
          />
        </Box>
      </CardContent>
      {/* <CardActions> */}
